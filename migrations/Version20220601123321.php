 ...
 */
final class Version20220601123321 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE document DROP file_name, CHANGE category category ENUM(\'Accessories\', \'Brochure\', \'PriceList\', \'Service\', \'Special model\', \'Voucher\') NOT NULL, CHANGE brand brand ENUM(\'Dacia\', \'Renault\') NOT NULL, CHANGE flag flag ENUM(\'Active\', \'Inactive\', \'Deleted\') NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE document ADD file_name VARCHAR(255) NOT NULL, CHANGE category category VARCHAR(255) NOT NULL, CHANGE brand brand VARCHAR(255) NOT NULL, CHANGE flag flag VARCHAR(255) NOT NULL');
